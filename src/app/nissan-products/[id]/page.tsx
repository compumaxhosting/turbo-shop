...
import ProductDetails from "@/components/product-details/ProductDetails"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = nissanInfinitiProductsData.find((prod) => prod.id === productId);

...
import { volvoProductsData } from "@/data/products-data/volvoProductsData";
...
const Page = () => {
  ...
  return (
    <>
      ...
      />
      <BreadcrumbSection
        title="SHOP VOLVO PRODUCTS"
        breadcrumbs={[{ label: "Home", href: "/" }, { label: "volvo-products" }]}
      />
      <ProductsSection productsData={volvoProductsData} />
      <ScrollToTop />
      <Footer />
    </>
  );

...
import { fordProductsData } from "@/data/products-data/fordProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = fordProductsData.find((prod) => prod.id === productId);

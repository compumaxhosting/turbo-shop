...
import { subaruProductsData } from "@/data/products-data/subaruProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = subaruProductsData.find((prod) => prod.id === productId);

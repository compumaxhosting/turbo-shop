...
import { cadillacProductsData } from "@/data/products-data/cadillacProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = cadillacProductsData.find((prod) => prod.id === productId);

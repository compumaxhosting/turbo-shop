...
import { lincolnProductsData } from "@/data/products-data/lincolnProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = lincolnProductsData.find((prod) => prod.id === productId);

...
import { miniProductsData } from "@/data/products-data/miniProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = miniProductsData.find((prod) => prod.id === productId);

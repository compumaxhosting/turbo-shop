...
import { jaguarProductsData } from "@/data/products-data/jaguarProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = jaguarProductsData.find((prod) => prod.id === productId);

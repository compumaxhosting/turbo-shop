...
import { chevroletProductsData } from "@/data/products-data/chevroletProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = chevroletProductsData.find((prod) => prod.id === productId);

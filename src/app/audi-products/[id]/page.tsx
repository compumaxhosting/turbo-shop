...
import { audiProductsData } from "@/data/products-data/audiProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = audiProductsData.find((prod) => prod.id === productId);

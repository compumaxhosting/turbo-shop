...
import { toyotaProductsData } from "@/data/products-data/toyotaProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = toyotaProductsData.find((prod) => prod.id === productId);

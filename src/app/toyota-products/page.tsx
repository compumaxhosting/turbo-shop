...
import { toyotaProductsData } from "@/data/products-data/toyotaProductsData";
...
const Page = () => {
  ...
  return (
    <>
      ...
      />
      <BreadcrumbSection
        title="SHOP TOYOTA PRODUCTS"
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "toyota-products" },
        ]}
      />
      <ProductsSection productsData={toyotaProductsData} />
      <ScrollToTop />
      <Footer />
    </>
  );

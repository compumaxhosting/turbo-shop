...
import { dodgeProductsData } from "@/data/products-data/dodgeProductsData"; // Make sure the path is correct
...
const ProductPage: React.FC<ProductPageProps> = ({ params }) => {
  ...
  const product = dodgeProductsData.find((prod) => prod.id === productId);

...
>(({ className, index, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-square h-16 sm:h-24 p-2 sm:p-3 w-full opacity-50 transition-opacity ${
          isSlideActive ? "!opacity-100 border border-primary" : "border border-gray-200 dark:border-stone-800"
        }`}
      >
        {children}
      </div>
